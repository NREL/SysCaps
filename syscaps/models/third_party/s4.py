...
# Try CUDA extension
try:
    from syscaps.models.third_party.extensions.kernels.cauchy import cauchy_mult as cauchy_cuda
    from syscaps.models.third_party.extensions.kernels.vandermonde import log_vandermonde_cuda
